...
function getURLParameter(e){return decodeURIComponent((new RegExp("[?|&]"+e+"=([^&;]+?)(&|#|;|$)").exec(location.search)||[null,""])[1].replace(/\+/g,"%20"))||null}new Vue({el:"#app",data:{loading:!0,hasCode:!1,trackCode:"",isLoaded:!1,items:null},created:function(){this.fetchData()},methods:{fetchData:function(){var e=this,t=getURLParameter("track");if(t){e.hasCode=!0,e.trackCode=t;var n="/api/"+t;e.$http.get(n).then(function(t){e.loading=!1,e.isLoaded=!0,e.items=t.body.items})}else console.log("No WORK")}}});
