...
function getURLParameter(e){return decodeURIComponent((new RegExp("[?|&]"+e+"=([^&;]+?)(&|#|;|$)").exec(location.search)||[null,""])[1].replace(/\+/g,"%20"))||null}new Vue({el:"#app",data:{loading:!0,hasCode:!1,trackCode:"",items:null},created:function(){this.fetchData()},methods:{fetchData:function(){var e=this,t=getURLParameter("track");t?(e.hasCode=!0,e.trackCode=t,e.apiEnpoint="/api/"+e.trackCode,e.$http.get(e.apiEnpoint).then(function(t){e.loading=!1,e.items=t.body.items})):console.log("No WORK")}}});
